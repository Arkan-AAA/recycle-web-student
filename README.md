...
|------|----------|-----------------|
| **Team Lead / Backend** | [Имя участника 1] | Архитектура, API, база данных |
| **Frontend Developer** | [Имя участника 2] | Пользовательский интерфейс, верстка |
| **Designer / Fullstack** | [Имя участника 3] | Дизайн, UX, фронтенд-разработка |
